...
public class AddressBookMain {
    ...
    private void viewPersonByCity(String cityName) {
        if (count > 0) {
            for (Map.Entry<String, AddressBook> entry : addressBookListMap.entrySet()) {
                AddressBook value = entry.getValue();
                ArrayList<ContactPerson> contacts = AddressBook.personByCity.entrySet().stream()
        ...
        if (count > 0) {
            for (Map.Entry<String, AddressBook> entry : addressBookListMap.entrySet()) {
                for (int i = 0; i < AddressBook.persons.size(); i++) {
                    ContactPerson contact = AddressBook.persons.get(i);
    ...
    public void CountByCity(String city) {
        ...
        if (count > 0) {
            for (Map.Entry<String, AddressBook> entry : addressBookListMap.entrySet()) {
                for (int i = 0; i < AddressBook.persons.size(); i++) {
                    ContactPerson d = AddressBook.persons.get(i);
    ...
    private void sortByName() {
        if (count > 0) {
            for (Map.Entry<String, AddressBook> entry : addressBookListMap.entrySet()) {
                AddressBook value = entry.getValue();
                List<ContactPerson> sortedList = AddressBook.persons.stream().sorted(Comparator.comparing(ContactPerson::getFirstName)).collect(Collectors.toList());
    ...
    void sortByState() {
        for (Map.Entry<String, AddressBook> entry : addressBookListMap.entrySet()) {
            AddressBook value = entry.getValue();
            List<ContactPerson> sortedList = AddressBook.persons.stream()
    ...
    public static void main(String[] args) {
        ...
        AddressBookMain addressBookClass = new AddressBookMain();
        boolean flag = true;
        while (flag) {
            while (flag) {
